...
public class ComCmdUtil {
  ...
  /**
   * 下发温度，   有返回值  温度  单位 0.1 lev:0 / 1 / 2 / 3
   */
  ...
  /**
   * 下发定时干燥，   有返回值  剩余时间上传 lev:0 / 1 / 2 / 3 /4
   */
  ...
  /**
   * 下发暖风，   有返回值 00 成功 / 01  当前状态未完成 lev:0 / 1
   */
  ...
  public static void sendSetInfo(Context context, MySqlUtil mysql) {
    ...
    switch (Integer.parseInt(WATER_TEMPER_LEV)) {
      case 0:
        WATER_TEMPER_VALUE = "0000";
        break;
      case 1:
        WATER_TEMPER_VALUE = "012C";
        break;
      case 2:
        WATER_TEMPER_VALUE = "014A";
        break;
      case 3:
        WATER_TEMPER_VALUE = "017C";
        break;
    }
    ...
    switch (Integer.parseInt(TIMER_DRY_LEV)) {
      case 0:
        TIMER_DRY_VALUE = "0000";
        break;//无自定干燥
      case 1:
        TIMER_DRY_VALUE = "003C";
        break;//60分钟
      case 2:
        TIMER_DRY_VALUE = "0078";
        break;//120分钟
      case 3:
        TIMER_DRY_VALUE = "00B4";
        break;//180分钟
      case 4:
        TIMER_DRY_VALUE = "00F0";
        break;//240分钟
    }
